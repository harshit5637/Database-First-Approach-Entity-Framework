...
namespace DatabaseFirstEFCore.Controllers
{
    ...
    {
        private readonly PersonsDatabaseContext _context;

        public HomeController(PersonsDatabaseContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Students != null ? 
                          ...
                          Problem("Entity set 'PersonsDatabaseContext.Students'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'PersonsDatabaseContext.Students'  is null.");
            }
            var student = await _context.Students.FindAsync(id);
            if (student != null)
            {
